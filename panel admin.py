...
class AdminApp(ctk.CTk):
    ...
    def actualizar_usuario(self):
        ...
        try:
            ...
            # Forzar validación estricta de base de datos
            cursor.execute("PRAGMA foreign_keys = ON;")
            
            # CONSULTA CORREGIDA: Se actualizan de verdad todas las columnas correspondientes
            cursor.execute("""
                UPDATE tblusuario 
                SET nombre = ?, 
                    apellido = ?, 
            ...
            # Refrescar la tabla con la animación cian
