...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Selector inteligente de pacientes
    document.getElementById("selector_paciente").addEventListener("change", (e) => {
        ...
        if (e.target.value === "nuevo") {
            ...
            // Teléfono no es obligatorio, pero sí recomendado
        } else {
...
function procesarCita(e) {
    ...
    const esNuevo        = selectPaciente === "nuevo";
 
    const payload = {
        id_usuario_existente: esNuevo ? null : parseInt(selectPaciente),
